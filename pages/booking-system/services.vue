              ...
              <td class="px-6 py-4">
                <span 
                  :class="[
                    ...
                    'inline-flex items-center rounded-full px-2.5 py-0.5 text-xs font-medium border bg-slate-100 text-slate-700 border-slate-200'
                  ]"
                >
    ...
    <div v-if="showDialog" class="fixed inset-0 z-50 flex items-center justify-center p-4 sm:p-6" role="dialog">
      ...
      <div class="z-10 w-full max-w-md bg-white rounded-xl shadow-2xl border border-slate-100 overflow-hidden animate-in zoom-in-95 duration-200">
        ...
        <div class="p-6 space-y-5">
          ...
          <div>
            <label class="block text-sm font-medium text-slate-700 mb-1.5">Abrechnungseinheit</label>
            <div class="relative">
              <input
