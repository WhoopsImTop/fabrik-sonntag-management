  ...
  <div v-else class="max-w-7xl mx-auto space-y-6 pb-24 font-sans text-neutral-900">
    <div class="flex flex-col md:flex-row md:items-end md:justify-between gap-4">
      <div class="space-y-1">
        ...
        <p class="text-sm text-neutral-500 pl-10">
          Erstelle eine neue Rechnung mit Services, Resourcen oder Freitext.
        </p>
      </div>

      <div class="flex items-center gap-2">
        <button type="button" class="btn-dialog-cancel" @click="router.back()">
          Abbrechen
        </button>

        <button type="button" class="btn-dialog-primary gap-2" :disabled="saving" @click="save">
