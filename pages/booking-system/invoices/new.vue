           ...
           <table class="w-full text-sm text-left">
            ...
            <tbody class="divide-y divide-neutral-100">
              ...
              >
                ...
                <td class="px-4 py-3 text-right">
                  <select v-model="item.vat_rate" class="w-full text-right bg-transparent border border-neutral-200 rounded focus:border-neutral-400 focus:ring-0 px-2 py-1 text-sm">
            ...
            <tfoot class="bg-neutral-50 border-t border-neutral-200">
              <tr>
                <td colspan="4" class="px-6 py-3 text-right text-neutral-600">Netto</td>
              ...
              <tr>
                <td colspan="4" class="px-6 py-4 text-right font-bold text-lg text-neutral-900">Gesamtbetrag</td>
